...
def user_detail(request, username):
    ...
    context = {'showPic': False}
    return render(request,
                  'account/detail.html',
                  {'section': 'people', 'user': user, 'actions': actions, 'context': context, 'showPic': False})
...
def dashboard(request):
    ...
    context = {'showPic': True}
    return render(request, 'account/dashboard.html',
                  {'section': 'dashboard', 'actions': actions, 'context': context})
